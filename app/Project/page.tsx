...
const Projects = () => {
  return (
    <Container>
      <div className="min-h-screen relative w-full overflow-hidden px-4 md:px-10 py-4">
       ...
       <h2 className="w-full text-2xl md:text-3xl font-bold text-blue-300 mb-6">Projects</h2>
